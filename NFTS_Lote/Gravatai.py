...
df = pd.read_excel('G:\\Drives compartilhados\\Finance 3.0\\1. Tax\\Fiscal Indiretos\\FILIAL L4B 0001 SP - ATIVA\\DMS\\Importação em lote planilha\\SAP Novo v1.1.xlsx', dtype=str, sheet_name='Gravatai')
...
# result.to_csv('0053NFTS_SP.txt', index=False, header=False)
result.to_csv('C:\\Users\\logger\\Downloads\\NFTS\\NFTS_RS.txt', index=False, header=False)
