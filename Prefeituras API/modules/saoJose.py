def nfts_SaoJose():
  df = pd.read_excel('/content/drive/Shareddrives/Finance 3.0/1. Tax/Fiscal Indiretos/FILIAL L4B 0001 SP - ATIVA/DMS/Importação em lote planilha/SAP Novo v1.1.xlsx', dtype=str, sheet_name='Filial São José')
