def nfts_Camacari():
  ...
  competencia = input('Informe a competência (yyyyMM): ')
  ...
  cabecalho = [f'10{competencia}{im}V01.2{linhas_formatted}{" " * 696}000001']
  ...
  with open('/content/drive/Shareddrives/Finance 3.0/1. Tax/Fiscal Indiretos/FILIAL L4B 0001 SP - ATIVA/DMS/Importação em lote planilha/Arquivos TXT/NFTS_BA.txt', 'w', encoding='ISO-8859-1') as file:
